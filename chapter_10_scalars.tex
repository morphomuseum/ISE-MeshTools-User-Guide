...
\section{Init RGB.}
Whenever colours are associated to vertices in .PLY of .VTK files (this can be achieved for instance by painting on meshes with Meshlab or by transferring textures obtained by laser scanning to the vertices), ISE-MeshTools stores this ``initial RGB" colour information inside a dedicated scalar (called ``Init\_RGB"). See for instance Fig. \ref{rgb_scalar}.
